...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Processings.UserAccesses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemoveUserAccessByIdAsync()
        {
            // given
            ...
            ValueTask<UserAccess> retrieveByIdUserAccessTask =
                this.userAccessProcessingService.RemoveUserAccessByIdAsync(invalidUserAccessId);
            ...
            this.userAccessServiceMock.Verify(broker =>
                broker.RemoveUserAccessByIdAsync(invalidUserAccessId),
                    Times.Never);
