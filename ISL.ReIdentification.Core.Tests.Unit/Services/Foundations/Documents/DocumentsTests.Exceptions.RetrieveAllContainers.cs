...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Documents
{
    public partial class DocumentsTests
    {
            ...
            Xeption dependencyValidationException)
        {
            ...
            // when
            ValueTask<List<string>> retrieveAllContainersTask =
                this.documentService.RetrieveAllContainersAsync();

            DocumentDependencyValidationException actualDocumentServiceException =
                await Assert.ThrowsAsync<DocumentDependencyValidationException>(retrieveAllContainersTask.AsTask);
        ...
        public async Task ShouldThrowDocumentDependencyExceptionOnRetrieveAllContainersAsync(
            Xeption dependencyException)
        {
            ...
            DocumentDependencyException actualDocumentDependencyException =
                await Assert.ThrowsAsync<DocumentDependencyException>(retrieveAllContainersTask.AsTask);
        ...
        public async Task ShouldThrowServiceExceptionOnRetrieveAllContainersAsync()
        {
            ...
            DocumentServiceException actualDocumentServiceException =
                await Assert.ThrowsAsync<DocumentServiceException>(retrieveAllContainersTask.AsTask);
