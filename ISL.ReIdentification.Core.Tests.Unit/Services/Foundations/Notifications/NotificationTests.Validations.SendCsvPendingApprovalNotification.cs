...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendPendingApprovalNotificationIfArgInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendPendingApprovalNotificationIfInputsIsInvalidAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = new AccessRequest
            {
