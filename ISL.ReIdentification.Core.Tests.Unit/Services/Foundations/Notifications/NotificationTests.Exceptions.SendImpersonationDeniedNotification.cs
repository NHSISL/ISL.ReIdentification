...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendImpersonationDeniedNotificationAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnSendImpersonationDeniedNotificationAndLogItAsync(
