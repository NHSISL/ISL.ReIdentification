...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationTests
    {
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnSendImpersonationTokensGeneratedNotificationIfArgInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnSendImpersonationTokensGeneratedNotificationIfObjectIsInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnSendImpersonationTokensGeneratedNotificationIfInputsIsInvalidAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = new AccessRequest
            {
