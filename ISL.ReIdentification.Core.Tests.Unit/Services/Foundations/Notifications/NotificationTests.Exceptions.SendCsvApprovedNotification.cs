...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendCsvApprovedNotificationAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnSendCsvApprovedNotificationAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendCsvApprovedNotificationAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = CreateRandomCsvAccessRequest();
            NotificationConfigurations invalidNotificationConfigurations = this.notificationConfigurations;
