...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationTests
    {
        ...
        public async Task
            ShouldThrowDependencyValidationExceptionOnSendImpersonationPendingApprovalNotificationAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnSendImpersonationPendingApprovalNotificationAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendImpersonationPendingApprovalNotificationAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = CreateImpersonationContextAccessRequest();
            NotificationConfigurations invalidNotificationConfigurations = this.notificationConfigurations;
