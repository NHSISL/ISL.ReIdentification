...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendImpersonationPendingApprovalNotificationIfArgInvalidAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask sendImpersonationPendingApprovalNotificationTask =
                notificationService.SendImpersonationPendingApprovalNotificationAsync(invalidAccessRequest);
            ...
            NotificationValidationException actualNotificationValidationException =
                await Assert.ThrowsAsync<NotificationValidationException>(
                    testCode: sendImpersonationPendingApprovalNotificationTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendImpersonationPendingApprovalNotificationIfCsvItemIsInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnSendImpersonationPendingApprovalNotificationIfInputsIsInvalidAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = new AccessRequest
            {
