...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendCsvDeniedNotificationAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnSendCsvDeniedNotificationAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendCsvDeniedNotificationAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = CreateRandomCsvAccessRequest();
            NotificationConfigurations invalidNotificationConfigurations = this.notificationConfigurations;
