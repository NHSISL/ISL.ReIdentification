...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    ...
    {
        [Fact]
        public async Task ShouldSendCsvDeniedNotificationAsync()
        {
            // given
            ...
            Dictionary<string, dynamic> personalisation = new Dictionary<string, dynamic>
            {
                ...
                { "templateId", this.notificationConfigurations.CsvDeniedRequestTemplateId },
            ...
            // when
            await this.notificationService.SendCsvDeniedNotificationAsync(accessRequest);
