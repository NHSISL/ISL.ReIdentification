...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendCsvDeniedNotificationIfArgInvalidAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask sendCsvDeniedNotificationTask =
                notificationService.SendCsvDeniedNotificationAsync(invalidAccessRequest);
            ...
            NotificationValidationException actualNotificationValidationException =
                await Assert.ThrowsAsync<NotificationValidationException>(
                    testCode: sendCsvDeniedNotificationTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendCsvDeniedNotificationIfCsvItemIsInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendCsvDeniedNotificationIfInputsIsInvalidAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = new AccessRequest
            {
