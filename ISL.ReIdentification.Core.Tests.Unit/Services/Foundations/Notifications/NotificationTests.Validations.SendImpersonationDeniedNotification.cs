...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.Notifications
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSendImpersonationDeniedNotificationIfArgInvalidAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask sendImpersonationDeniedNotificationTask =
                notificationService.SendImpersonationDeniedNotificationAsync(invalidAccessRequest);
            ...
            NotificationValidationException actualNotificationValidationException =
                await Assert.ThrowsAsync<NotificationValidationException>(
                    testCode: sendImpersonationDeniedNotificationTask.AsTask);
        ...
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnSendImpersonationDeniedNotificationIfCsvItemIsInvalidAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async
            Task ShouldThrowValidationExceptionOnSendImpersonationDeniedNotificationIfInputsIsInvalidAndLogItAsync()
        {
            // given
            AccessRequest invalidAccessRequest = new AccessRequest
            {
