...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Orchestrations.Persists
{
    public partial class PersistanceOrchestrationServiceTests
    {
        [Fact]
        public async Task
            ShouldThrowValidationExceptionOnPersistImpersonationContextWhenAccessRequestIsNullAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnPersistImpersonationContextWhenInvalidAndLogItAsync()
        {
            // given
