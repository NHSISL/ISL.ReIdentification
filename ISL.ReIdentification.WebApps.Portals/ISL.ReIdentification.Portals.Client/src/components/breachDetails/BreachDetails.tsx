export const BreachDetails = () => {
    return <>
        ...
        <p>The guidance defines what constitues a breach of patient confidentiality when performing reidentification.</p>
        <p>Our DSCRO reidentification partner (NECS) will monitor all activity and reserve the right to raise a breach report to NHS England should they detect any requests in excess of the following thresholds:</p>
        <ol>
            <li>Reidentification requests on more than 1 occasion between the hours of 9pm and 6am.</li>
            <li>Reidentification request is undertaken during an organisations/ GP practice non-working days.</li>
            ...
            <li>Reidentification of over 1000 distinct NHS numbers from the one user over a reporting period </li>
            ...
            <li>Reidentification of distinct NHS numbers over 6% of GP practice size over a reporting period*</li>
            <li>Reidentification of distinct NHS numbers over 6% of GP practice size by CCG over a reporting period*</li>
